...
export default function Sidebar({ onManageFloors }: SidebarProps) {
  const [activeItem, setActiveItem] = useState("parking")
  ...
  return (
    <div className="w-64 bg-white/80 backdrop-blur-sm border-r border-purple-200 h-full flex flex-col">
      {/* Logo */}
              ...
              <li key={item.id}>
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-left transition-colors ${
                    isActive ? "bg-purple-500 text-white" : "text-gray-700 hover:bg-purple-100"
                  }`}
                >
                  <Icon />
