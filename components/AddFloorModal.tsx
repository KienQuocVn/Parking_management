...
export default function AddFloorModal({ isOpen, onClose, onAddFloor, existingFloors }: AddFloorModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-800">Add New Floor</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <p className="text-sm text-gray-600 mb-2">Existing floors:</p>
            <div className="flex flex-wrap gap-2">
              {existingFloors.map((floor) => (
                <span key={floor} className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded">
                  {floor}
                </span>
              ))}
            </div>
